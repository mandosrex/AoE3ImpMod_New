...
//	rmSetMapElevationHeightBlend(1);
	...
	int avoidSerowFar = rmCreateTypeDistanceConstraint("avoid Serow far", "Peafowl", 52.0);
	int avoidSerow = rmCreateTypeDistanceConstraint("avoid Serow", "Peafowl", 50.0);
	int avoidSerowShort = rmCreateTypeDistanceConstraint("avoid Serow short", "Peafowl", 20.0);
	int avoidSerowMin = rmCreateTypeDistanceConstraint("avoid Serow min", "Peafowl", 4.0);
	...
	int avoidNuggetWater = rmCreateTypeDistanceConstraint("avoid nugget water", "AbstractNugget", 80.0);
...
//	rmSetAreaTerrainType(natAreaB, "new_england\ground2_cliff_ne");
	...
	int nativeID3 = -1;
		...
		nativeID0 = rmCreateGrouping("Jesuit mission A", "native jesuit mission cj 0"+4);
		nativeID1 = rmCreateGrouping("Jesuit mission B", "native jesuit mission cj 0"+3);
...
//	rmSetGroupingMaxDistance(nativeID1, 0.00);
	...
	rmSetObjectDefMaxDistance(playerCrateID, 11);
...
//		rmAddObjectDefConstraint(randominlandtreeID, avoidTradeRouteSocket);
	...
	for (i=0; < serowherdcount)
	{
		...
		rmAddObjectDefItem(serowherdID, "Peafowl", rmRandInt(7,8), 6.0);
