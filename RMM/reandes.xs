...
// PLAYER STARTING RESOURCES
	...
	int playerGuanacoID=rmCreateObjectDef("player guanaco");
      rmAddObjectDefItem(playerGuanacoID, "guanaco", rmRandInt(10,10), 7.0);
      rmSetObjectDefMinDistance(playerGuanacoID, 12);
	...
	int farGuanacoID=rmCreateObjectDef("player far guanaco");
      rmAddObjectDefItem(farGuanacoID, "guanaco", rmRandInt(10,10), 7.0);
