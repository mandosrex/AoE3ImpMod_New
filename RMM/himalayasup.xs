...
void main(void)
{
  ...
  int lakotaVillageCID = -1;
  int lakotaVillageDID = -1;
  int lakotaVillageEID = -1;
  int lakotaVillageFID = -1;
  ...
  lakotaVillageType = rmRandInt(1,5);
  lakotaVillageCID = rmCreateGrouping("village 1C", "native " +nativeCiv3+ " temple YR 0"+lakotaVillageType);
  rmSetGroupingMinDistance(lakotaVillageCID, 0.0);
  rmSetGroupingMaxDistance(lakotaVillageCID, 25.0);
  rmAddGroupingConstraint(lakotaVillageCID, avoidImpassableLand);
  rmAddGroupingConstraint(lakotaVillageCID, playerConstraintImportantItem);
  rmAddGroupingToClass(lakotaVillageCID, rmClassID("importantItem"));
  rmAddGroupingConstraint(lakotaVillageCID, avoidImportantItemFar);
  rmAddGroupingConstraint(lakotaVillageCID, nativeConstraint);
  rmAddGroupingConstraint(lakotaVillageCID, avoidTradeRoute);
  rmAddGroupingConstraint(lakotaVillageCID, avoidSocket);
  rmPlaceGroupingAtLoc(lakotaVillageCID, 0, 0.5, 0.8);

  lakotaVillageType = rmRandInt(1,5);
  lakotaVillageDID = rmCreateGrouping("village 1D", "native " +nativeCiv3+ " temple YR 0"+lakotaVillageType);
  rmSetGroupingMinDistance(lakotaVillageDID, 0.0);
  rmSetGroupingMaxDistance(lakotaVillageDID, 25.0);
  rmAddGroupingConstraint(lakotaVillageDID, avoidImpassableLand);
  rmAddGroupingConstraint(lakotaVillageDID, playerConstraintImportantItem);
  rmAddGroupingToClass(lakotaVillageDID, rmClassID("importantItem"));
  rmAddGroupingConstraint(lakotaVillageDID, avoidImportantItemFar);
  rmAddGroupingConstraint(lakotaVillageDID, nativeConstraint);
  rmAddGroupingConstraint(lakotaVillageDID, avoidTradeRoute);
  rmAddGroupingConstraint(lakotaVillageDID, avoidSocket);
  rmPlaceGroupingAtLoc(lakotaVillageDID, 0, 0.5, 0.2);
  ...
  if(cNumberNonGaiaPlayers > 4) {
    ...
    lakotaVillageType = rmRandInt(1,5);
    lakotaVillageEID = rmCreateGrouping("village 1E", "native " +nativeCiv1+ " village himal "+lakotaVillageType);
    rmSetGroupingMinDistance(lakotaVillageEID, 0.0);
    rmSetGroupingMaxDistance(lakotaVillageEID, 25.0);
    rmAddGroupingConstraint(lakotaVillageEID, avoidImpassableLand);
    rmAddGroupingConstraint(lakotaVillageEID, playerConstraintImportantItem);
    rmAddGroupingToClass(lakotaVillageEID, rmClassID("importantItem"));
    rmAddGroupingConstraint(lakotaVillageEID, avoidImportantItemFar);
    rmAddGroupingConstraint(lakotaVillageEID, nativeConstraint);
    rmAddGroupingConstraint(lakotaVillageEID, avoidTradeRoute);
    rmAddGroupingConstraint(lakotaVillageEID, avoidSocket);
    rmPlaceGroupingAtLoc(lakotaVillageEID, 0, 0.4, 0.65);

    lakotaVillageType = rmRandInt(1,5);
    lakotaVillageFID = rmCreateGrouping("village 2F", "native " +nativeCiv2+ " village himal "+lakotaVillageType);
    rmSetGroupingMinDistance(lakotaVillageFID, 0.0);
    rmSetGroupingMaxDistance(lakotaVillageFID, 25.0);
    rmAddGroupingConstraint(lakotaVillageFID, avoidImpassableLand);
    rmAddGroupingConstraint(lakotaVillageFID, playerConstraintImportantItem);
    rmAddGroupingToClass(lakotaVillageFID, rmClassID("importantItem"));
    rmAddGroupingConstraint(lakotaVillageFID, avoidImportantItemFar);
    rmAddGroupingConstraint(lakotaVillageFID, nativeConstraint);
    rmAddGroupingConstraint(lakotaVillageFID, avoidTradeRoute);
    rmAddGroupingConstraint(lakotaVillageFID, avoidSocket);
    rmPlaceGroupingAtLoc(lakotaVillageFID, 0, 0.6, 0.35);
