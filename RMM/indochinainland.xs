...
// Constraints
  ...
  int playerConstraintNative=rmCreateClassDistanceConstraint("natives stay away from players far", classPlayer, 75.0);
	...
	int longAvoidImpassableLand=rmCreateTerrainDistanceConstraint("long avoid impassable land", "Land", false, 14.0);
  ...
  int avoidEdgeConstraint=rmCreatePieConstraint("avoid edge of map", 0.5, 0.5, 0, rmGetMapXSize()-25, 0, 0, 0);
...
// ************************** DEFINE OBJECTS ****************************
  ...
  rmAddObjectDefItem(playerFirepitID, "NativeEmbassy", 1, 0.0);
  ...
  //~ if(cNumberNonGaiaPlayers > 4)
    	//~ rmSetAreaSize(mainIslandID, 1.0, 1.0);
  ...
  // Length of peninsula
  rmAddAreaInfluenceSegment(mainIslandID, 1.0, 1.0, 1.0, 1.0);
  rmAddAreaInfluenceSegment(mainIslandID, 1.0, 1.0, 1.0, 1.0);
  rmAddAreaInfluenceSegment(mainIslandID, 1.0, 1.0, 1.0, 1.0);
  rmAddAreaInfluenceSegment(mainIslandID, 1.0, 1.0, 1.0, 1.0);
  rmAddAreaInfluenceSegment(mainIslandID, 1.0, 1.0, 1.0, 1.0);
  ...
  if (weird == false) {
    ...
    if (cNumberNonGaiaPlayers == 2) {
      if (teamStartLoc > 0.5) {
        ...
        rmPlacePlayersLine(0.2, 0.5, 0.2, 0.45, 0.1, 0);
          
        rmSetPlacementTeam(1);
        rmPlacePlayersLine(0.8, 0.5, 0.8, 0.45, 0.1, 0);                
      }
      else {
        rmSetPlacementTeam(1);
        rmPlacePlayersLine(0.2, 0.5, 0.2, 0.45, 0.1, 0);
      ...
      if (teamStartLoc > 0.5) {
        rmSetPlacementTeam(0);
        rmPlacePlayersLine(0.2, 0.66, 0.2, 0.34, 0.1, 0);

        rmSetPlacementTeam(1);
        rmPlacePlayersLine(0.8, 0.66, 0.8, 0.34, 0.1, 0);  
      }
      else {
        rmSetPlacementTeam(1);
        rmPlacePlayersLine(0.2, 0.66, 0.2, 0.34, 0.1, 0);
  ...
  // ffa
    ...
    rmPlacePlayer(1, .15, .6);
    rmPlacePlayer(2, .85, .4);
    rmPlacePlayer(3, .34, .2);
    rmPlacePlayer(4, .66, .8);
    rmPlacePlayer(5, .15, .4);
    rmPlacePlayer(6, .85, .6);
    rmPlacePlayer(7, .34, .8);
    rmPlacePlayer(8, .66, .2);
  }
  ...
  if (subCiv0 == rmGetCivID(nativeCiv1)) {  
    ...
    rmAddGroupingConstraint(nativeVillage1ID, avoidEdgeConstraint);
  ...
  if (subCiv1 == rmGetCivID(nativeCiv2)) {  
    ...
    int nativeVillage2ID = rmCreateGrouping("native village 2", "native shaolin temple yr 0"+nativeVillage2Type);
    ...
    rmAddGroupingConstraint(nativeVillage2ID, avoidEdgeConstraint);
  ...
  if (subCiv1 == rmGetCivID(nativeCiv2)) {  
    ...
    nativeVillage2ID = rmCreateGrouping("native village 2a", "native shaolin temple yr 0"+nativeVillage2Type);
    rmSetGroupingMinDistance(nativeVillage2ID, 0.0);
    rmSetGroupingMaxDistance(nativeVillage2ID, 10.0);
    rmAddGroupingToClass(nativeVillage2ID, rmClassID("importantItem"));
    rmAddGroupingConstraint(nativeVillage2ID, avoidImportantItem);
  ...
  if(cNumberNonGaiaPlayers > 3) {
    ...
    if (subCiv1 == rmGetCivID(nativeCiv2)) {  
      nativeVillage2Type = rmRandInt(1,5);
      nativeVillage2ID = rmCreateGrouping("native village 2b", "native shaolin temple yr 0"+nativeVillage2Type);
      rmSetGroupingMinDistance(nativeVillage2ID, 0.0);
      rmSetGroupingMaxDistance(nativeVillage2ID, 10.0);
      rmAddGroupingToClass(nativeVillage2ID, rmClassID("importantItem"));
      rmAddGroupingConstraint(nativeVillage2ID, avoidImportantItem);
  ...
  if(cNumberNonGaiaPlayers > 5) {
    ...
    if (subCiv1 == rmGetCivID(nativeCiv2)) {  
      nativeVillage2Type = rmRandInt(1,5);
      nativeVillage2ID = rmCreateGrouping("native village 2c", "native shaolin temple yr 0"+nativeVillage2Type);
      rmSetGroupingMinDistance(nativeVillage2ID, 0.0);
      rmSetGroupingMaxDistance(nativeVillage2ID, 10.0);
      rmAddGroupingToClass(nativeVillage2ID, rmClassID("importantItem"));
      rmAddGroupingConstraint(nativeVillage2ID, avoidImportantItem);
  ...
  if(cNumberNonGaiaPlayers > 7) {
    ...
    if (subCiv1 == rmGetCivID(nativeCiv2)) {  
      nativeVillage2Type = rmRandInt(1,5);
      nativeVillage2ID = rmCreateGrouping("native village 2d", "native shaolin temple yr 0"+nativeVillage2Type);
      rmSetGroupingMinDistance(nativeVillage2ID, 0.0);
      rmSetGroupingMaxDistance(nativeVillage2ID, 10.0);
      rmAddGroupingToClass(nativeVillage2ID, rmClassID("importantItem"));
      rmAddGroupingConstraint(nativeVillage2ID, avoidImportantItem);
  ...
  rmPlaceObjectDefAtLoc(food1ID, 0, 0.5, 0.5, 3.5*cNumberNonGaiaPlayers);
  rmPlaceObjectDefAtLoc(food2ID, 0, 0.5, 0.5, 4.0*cNumberNonGaiaPlayers);
