...
//	rmAddObjectDefConstraint(StartAreaTreeID, playerConstraint);
	...
	//rmSetObjectDefCreateHerd(StartBerriesID, false);
	...
	int StartRheaID=rmCreateObjectDef("starting rhea");
	rmAddObjectDefItem(StartRheaID, "rhea", 4, 5.0);
	rmSetObjectDefCreateHerd(StartRheaID, false);
	rmSetObjectDefMinDistance(StartRheaID, 10);
	rmSetObjectDefMaxDistance(StartRheaID, 20);
	rmAddObjectDefConstraint(StartRheaID, avoidStartResource);
	rmAddObjectDefConstraint(StartRheaID, shortAvoidImpassableLand);
	rmAddObjectDefConstraint(StartRheaID, avoidNatives);
	//rmAddObjectDefConstraint(StartRheaID, deerAvoidDeer);
	rmAddObjectDefConstraint(StartRheaID, shortPlayerConstraint);
	//rmPlaceObjectDefPerPlayer(StartRheaID, true);
...
*/
  ...
  if(rmGetIsKOTH()) {
	...
	//rmAddObjectDefItem(randomEagleTreeID, "PropEaglesRocks", 1, 2.0);
