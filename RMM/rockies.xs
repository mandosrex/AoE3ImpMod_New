...
void main(void)
{
   ...
   */
   ...
   rmSetObjectDefMaxDistance(socketID, 12.0);
	...
	rmAddRandomTradeRouteWaypoints(tradeRouteID, 0.5, 0.3, 10, 4);
	rmAddRandomTradeRouteWaypoints(tradeRouteID, 0.2, 0.35, 10, 4);
   ...
   rmSetObjectDefMaxDistance(socketID, 12.0);
	...
	rmAddTradeRouteWaypoint(tradeRoute2ID, 0.8, 0.65);
	rmAddRandomTradeRouteWaypoints(tradeRoute2ID, 0.5, 0.7, 10, 4);
	rmAddRandomTradeRouteWaypoints(tradeRoute2ID, 0.2, 0.65, 10, 4);
   ...
   int startingUnits = rmCreateStartingUnitsObjectDef(5.0);
	...
	rmSetObjectDefMinDistance(StartBighornID, 12.0);
	rmSetObjectDefMaxDistance(StartBighornID, 15.0);
