...
void main(void)
{
  ...
  int avoidOutpostAsian=rmCreateTypeDistanceConstraint("avoid Asian outposts", "ypCastle", 24.0);
   ...
   // starting resources
	...
	rmSetObjectDefMinDistance(StartPronghornID, 10);
	rmSetObjectDefMaxDistance(StartPronghornID, 14);
   ...
   */
   ...
   rmAddObjectDefItem(playerBisonID, "bison", rmRandInt(8,8), 6.0);
  ...
  rmAddObjectDefItem(startingOutpostAsianID, "ypCastle", 1, 0.0);
  ...
  rmEchoInfo("Variation2 = " + whichVariation);
   ...
   rmAddObjectDefItem(pronghornHerdID, "pronghorn", rmRandInt(4,5), 6.0);
