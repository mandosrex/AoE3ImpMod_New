...
void main(void)
{
  ...
  baseTerrain = "rockies\groundsnow6_roc";
  forestType = "rockies snow forest";
  startTreeType = "TreeRockiesSnow";
  mapType1 = "siberia";
  mapType2 = "grass";
...
// ************************** DEFINE OBJECTS ****************************
  ...
  rmSetAreaObeyWorldCircleConstraint(IceArea1ID, false);
	rmSetAreaMinBlobs(IceArea1ID, 3);
	rmSetAreaMaxBlobs(IceArea1ID, 7);
	rmSetAreaMinBlobDistance(IceArea1ID, 4);
	rmSetAreaMaxBlobDistance(IceArea1ID, 7);
	rmSetAreaSmoothDistance(IceArea1ID, 7);
  ...
  for(i = 0; < rmRandInt(7, 9)) {
    ...
    rmSetAreaMinBlobs(IceAreaID, 2);
    rmSetAreaMaxBlobs(IceAreaID, 4);
	  rmSetAreaMinBlobDistance(IceAreaID, 12);
	  rmSetAreaMaxBlobDistance(IceAreaID, 15);
    rmSetAreaSmoothDistance(IceAreaID, 7);
