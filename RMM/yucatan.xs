...
//   int longPlayerConstraint=rmCreateClassDistanceConstraint("land stays away from players", classPlayer, 24.0);
  ...
  // int nearWater10 = rmCreateTerrainDistanceConstraint("near water", "Water", true, 10.0);
   ...
   int avoidWater12 = rmCreateTerrainDistanceConstraint("avoid water long", "Land", false, 12.0);
   int avoidWater20 = rmCreateTerrainDistanceConstraint("avoid water longer", "Land", false, 20.0);
   int nearWater10 = rmCreateTerrainDistanceConstraint("near water", "Water", true, 10.0);
...
//***************************************  Starting Resources  ********************************************  
   ...
   rmAddObjectDefItem(playerBerryID, "berryBush", rmRandInt(2,2), 5.0);
   rmSetObjectDefMinDistance(playerBerryID, 11);
   ...
   int playerHuntsID=rmCreateObjectDef("player hunts");
   rmAddObjectDefItem(playerHuntsID, "anteater", rmRandInt(4,4), 5.0);
   rmSetObjectDefMinDistance(playerHuntsID, 11);
   rmSetObjectDefMaxDistance(playerHuntsID, 15);
   rmAddObjectDefConstraint(playerHuntsID, avoidAll);
   rmAddObjectDefConstraint(playerHuntsID, avoidImpassableLand);
   rmAddObjectDefToClass(playerHuntsID, rmClassID("startingUnit"));
   rmPlaceObjectDefPerPlayer(playerHuntsID, false);
   ...
   for(i=1; <cNumberPlayers)
   {
	   ...
	   else
	   {
		   ...
		   rmAddGroupingConstraint(nativeVillageID, avoidTradeRouteFar);
		   rmAddGroupingConstraint(nativeVillageID, avoidImportantItem);
		   rmAddGroupingConstraint(nativeVillageID, avoidTC);
		   rmAddGroupingConstraint(nativeVillageID, avoidWater20);
...
*/
  ...
  // Another cliff
   ...
   for(i=0; <numTries)
   {
      ...
      rmSetAreaCliffType(cliff2ID, "Amazon Inland");
...
// **************************  Resources that can be placed after forests (Hunting)  ***************************
   ...
   rmAddObjectDefItem(tapirID, "anteater", tapirCount, 2.0);
   ...
   rmAddObjectDefItem(tapir2ID, "anteater", tapirCount, 2.0);
