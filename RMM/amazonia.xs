...
*/
	int tradeRouteNum = 2; //force dual trade route 
   ...
   if (cNumberTeams == 2)
	...
	if (rmGetNomadStart())
		...
		rmAddObjectDefConstraint(playerMarketID, avoidAll);
		...
		int playerNativeMarketID = rmCreateObjectDef("player native market");
		rmAddObjectDefItem(playerNativeMarketID, "marketnative", 1, 0);
		rmAddObjectDefConstraint(playerNativeMarketID, avoidTradeRoute);
		rmSetObjectDefMinDistance(playerNativeMarketID, 10.0);
		rmSetObjectDefMaxDistance(playerNativeMarketID, 18.0);
		rmAddObjectDefConstraint(playerNativeMarketID, avoidAll);
		rmAddObjectDefConstraint(playerNativeMarketID, playerEdgeConstraint);
		rmAddObjectDefConstraint(playerNativeMarketID, mediumShortAvoidImpassableLand);
    ...
    int playerAsianMarketID = rmCreateObjectDef("player asian market");
		...
		rmAddObjectDefConstraint(playerAsianMarketID, avoidAll);
  ...
  rmAddObjectDefItem(playerDeerID, "anteater", rmRandInt(7,7), 10.0);
  rmSetObjectDefMinDistance(playerDeerID, 11);
  ...
  rmAddObjectDefItem(playerTreeID, "TreeAmazon", rmRandInt(8,10), 2.0);
  ...
  float NativeVillageLoc = rmRandFloat(0,1);
   ...
   {  
      ...
      rmAddGroupingConstraint(tupiVillageID, avoidSocketActual);
...
//      rmAddGroupingConstraint(tupiVillageID, avoidTradeRoute);
   ...
   {  
      ...
      rmAddGroupingConstraint(zapotecVillageID, avoidSocketActual);
   ...
   {   
      ...
      rmAddGroupingConstraint(tupi2VillageID, avoidSocketActual);
   ...
   {   
      ...
      rmAddGroupingConstraint(Zapotec2VillageID, avoidSocketActual);
