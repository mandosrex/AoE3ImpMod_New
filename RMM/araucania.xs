...
//********************************************************************************//
   ...
   int whichNative = -1;
	...
	if (rmIsWinterVariant()) {
		whichVariation = 3;
	} else if (rmIsSummerVariant()) {
		whichVariation = 1;
	}
...
//********************************************************************************//
   ...
   if (cNumberTeams > 2) // Free-for-all
   {
      ...
      rmSetObjectDefMaxDistance(townCenter, 80.0);
   ...
   {
      rmSetObjectDefMinDistance(townCenter, 0.0);
      rmSetObjectDefMaxDistance(townCenter, 40.0);
      rmAddObjectDefToClass(townCenter, classStartingUnits);
      rmAddObjectDefConstraint(townCenter, avoidTradeRouteFar);
      rmAddObjectDefConstraint(townCenter, avoidAllMedium);
      rmAddObjectDefConstraint(townCenter, edgeConstraint);
  ...
  //~ rmAddObjectDefConstraint(monasteryID, avoidImpassableFar);
   ...
   rmAddObjectDefItem(startingHunting, "Guanaco", rmRandInt(4,4), 4.0);
   rmSetObjectDefMinDistance(startingHunting, 14.0);
   rmSetObjectDefMaxDistance(startingHunting, 20.0);
   rmSetObjectDefCreateHerd(startingHunting, false);
   ...
   rmAddObjectDefItem(startingHunting2, "Guanaco", rmRandInt(6,6), 4.0);
...
//********************************************************************************//
      ...
      rmAddGroupingConstraint(nativeVillage, avoidTradeRouteClose);
      rmAddGroupingConstraint(nativeVillage, avoidWater);
...
//********************************************************************************//
  ...
  if(rmGetIsKOTH()) {
   ...
   for (i = 0; < numberDeerPasses * cNumberNonGaiaPlayers)
   {
      ...
      rmAddObjectDefItem(huntingDeerNorth, "Penguin", herdSizeHunting, 4.0);
   ...
   for (i = 0; < numberDeerPasses * cNumberNonGaiaPlayers)
   {
      ...
      rmAddObjectDefItem(huntingDeerSouth, "Penguin", herdSizeHunting, 4.0);
...
//********************************************************************************//
   ...
   for (i = 0; < numberNuggetEasyPasses * cNumberNonGaiaPlayers)
   {
      ...
      rmAddObjectDefConstraint(northNuggetsEasy, avoidWater);
      rmSetNuggetDifficulty(1, 1);
   ...
   for (i = 0; < cNumberNonGaiaPlayers)
   {
      ...
      rmAddObjectDefConstraint(northNuggetsModerate, avoidWater);
      rmSetNuggetDifficulty(2, 2);
...
//********************************************************************************//
   ...
   for (i = 0; < numberNuggetHardNutsPasses * cNumberNonGaiaPlayers)
   {
      ...
      rmAddObjectDefConstraint(northNuggetsHard, avoidWater);
   ...
   for (i = 0; < numberNuggetHardNutsPasses * cNumberNonGaiaPlayers) 
   {
      ...
      rmAddObjectDefConstraint(noMansLandNuggetNuts, avoidWater);
   ...
   for (i = 0; < numberNuggetEasyPasses * cNumberNonGaiaPlayers)
   {
      ...
      rmAddObjectDefConstraint(southNuggetsEasy, avoidWater);
      rmSetNuggetDifficulty(1, 1);
   ...
   for (i = 0; < cNumberNonGaiaPlayers)
   {
      ...
      rmAddObjectDefConstraint(southNuggetsModerate, avoidWater);
      rmSetNuggetDifficulty(2, 2);
   ...
   for (i = 0; < numberNuggetHardNutsPasses * cNumberNonGaiaPlayers)
   {
      ...
      rmAddObjectDefConstraint(southNuggetsHard, avoidWater);
      rmSetNuggetDifficulty(3, 3);
