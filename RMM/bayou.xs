...
//	rmSetMapElevationParameters(cElevTurbulence, 0.1, 4, 0.3, 2.0);
	...
	int avoidDeer=rmCreateTypeDistanceConstraint("food avoids food", "anteater", 50.0);
...
*/
	...
	int startHuntsID=rmCreateObjectDef("starting Hunts");
	rmAddObjectDefItem(startHuntsID, "turkey", 4, 5.0);
	rmSetObjectDefCreateHerd(startHuntsID, false);
	rmSetObjectDefMinDistance(startHuntsID, 10);
	rmSetObjectDefMaxDistance(startHuntsID, 15);
	rmAddObjectDefToClass(startHuntsID, rmClassID("startingUnit"));
	rmAddObjectDefConstraint(startHuntsID, avoidImpassableLand);
	//rmAddObjectDefConstraint(startHuntsID, avoidTradeRoute);
	rmAddObjectDefConstraint(startHuntsID, avoidStartingUnits);
	rmAddObjectDefConstraint(startHuntsID, avoidResource);
...
*/
	...
	rmAddObjectDefItem(silver2ID, "MineShipRuins", 1, 0);
...
// Text
   rmSetStatusText("",0.80);
	...
	rmAddObjectDefItem(deerID, "anteater", rmRandInt(8,10), 10.0);
