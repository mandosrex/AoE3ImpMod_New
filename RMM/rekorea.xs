...
// initialize map type variables
  ...
  string patchTerrain = "tropic\ground_grass2_tropic";
  string patchType1 = "tropic\ground_grass1_tropic";
  string patchType2 = "tropic\ground_grass3_tropic";
  
  string lightingType = "caribbean";
