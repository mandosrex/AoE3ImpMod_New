...
void main(void)
{
  ...
  int longerPlayerConstraint=rmCreateClassDistanceConstraint("stay away from players more", classPlayer, 45.0);

  // new directional constraints
   int Eastward=rmCreatePieConstraint("eastMapConstraint", 0.5, 0.5, 0, rmZFractionToMeters(0.5), rmDegreesToRadians(50), rmDegreesToRadians(220));
   int Westward=rmCreatePieConstraint("westMapConstraint", 0.5, 0.5, 0, rmZFractionToMeters(0.5), rmDegreesToRadians(230), rmDegreesToRadians(40));
  ...
  // Food
  //herdable1 - east
  int herdableNum=cNumberNonGaiaPlayers*2;
  if(cNumberNonGaiaPlayers > 2)
     herdableNum=cNumberNonGaiaPlayers*2;

  int herdable1ID=rmCreateObjectDef("herdable east");
  ...
  rmAddObjectDefConstraint(herdable1ID, longerPlayerConstraint);
  rmAddObjectDefConstraint(herdable1ID, Eastward);
  rmPlaceObjectDefAtLoc(herdable1ID, 0, 0.5, 0.5, herdableNum);   
   
  // Herdable2 - west
  int Herdable2ID=rmCreateObjectDef("Herdable west");
  ...
  rmAddObjectDefConstraint(Herdable2ID, longerPlayerConstraint);
  rmAddObjectDefConstraint(Herdable2ID, Westward);
  rmPlaceObjectDefAtLoc(Herdable2ID, 0, 0.5, 0.5, herdableNum); 
   
	// Huntable1	
  int fairNum = rmRandInt(8,10);
  int Huntable1ID=rmCreateObjectDef("Huntable1 herd west");
  rmAddObjectDefItem(Huntable1ID, huntable1, fairNum, 12.0);
  ...
  rmAddObjectDefConstraint(Huntable1ID, Westward);
  rmPlaceObjectDefAtLoc(Huntable1ID, 0, 0.5, 0.5, cNumberNonGaiaPlayers*0.5);

  Huntable1ID=rmCreateObjectDef("Huntable1 herd east");
  rmAddObjectDefItem(Huntable1ID, huntable1, fairNum, 12.0);
  rmSetObjectDefMinDistance(Huntable1ID, 0.0);
  rmSetObjectDefMaxDistance(Huntable1ID, rmXFractionToMeters(0.5));
  rmAddObjectDefConstraint(Huntable1ID, avoidHuntable1);
  ...
  rmSetObjectDefCreateHerd(Huntable1ID, true);
  rmAddObjectDefConstraint(Huntable1ID, avoidDesert);
  rmAddObjectDefConstraint(Huntable1ID, Eastward);
  rmPlaceObjectDefAtLoc(Huntable1ID, 0, 0.5, 0.5, cNumberNonGaiaPlayers*0.5);

	// huntable2
  fairNum = rmRandInt(8,9);	
  int huntable2ID=rmCreateObjectDef("huntable2 herd east");
  rmAddObjectDefItem(huntable2ID, huntable2, fairNum, 12.0);
  ...
  rmAddObjectDefConstraint(huntable2ID, Eastward);
  rmPlaceObjectDefAtLoc(huntable2ID, 0, 0.5, 0.5, cNumberNonGaiaPlayers);

  huntable2ID=rmCreateObjectDef("huntable2 herd west");
  rmAddObjectDefItem(huntable2ID, huntable2, fairNum, 12.0);
  rmSetObjectDefMinDistance(huntable2ID, 0.0);
  rmSetObjectDefMaxDistance(huntable2ID, rmXFractionToMeters(0.5));
  rmAddObjectDefConstraint(huntable2ID, avoidHuntable1);
  ...
  fairNum=rmRandInt(7,8);
  int huntable3ID=rmCreateObjectDef("huntable2 herd 2 west");
  rmAddObjectDefItem(huntable3ID, huntable2, fairNum, 8.0);
  ...
  rmAddObjectDefConstraint(huntable3ID, Westward);
  rmPlaceObjectDefInArea(huntable3ID, 0, desertID, cNumberNonGaiaPlayers);

  huntable3ID=rmCreateObjectDef("huntable2 herd 2 east");
  rmAddObjectDefItem(huntable3ID, huntable2, fairNum, 8.0);
  rmSetObjectDefMinDistance(huntable3ID, 0.0);
  rmSetObjectDefMaxDistance(huntable3ID, rmXFractionToMeters(0.5));
  rmAddObjectDefConstraint(huntable3ID, avoidHuntable1);
