...
void main(void)
{
  ...
  string riverType2 = "Yellow River3";
...
// Objects
  ...
  int huntable3ID=rmCreateObjectDef("huntable 3");
	rmAddObjectDefItem(huntable3ID, huntable3, rmRandInt(4,5), 6.0);
  ...
  int yellowRiver3 = rmRiverCreate(-1, riverType, 6, 20, rivermin+10, rivermax+10);
  ...
  int yellowRiver6 = rmRiverCreate(-1, riverType2, 3, 10, rivermin, rivermax);
  int yellowRiver7 = rmRiverCreate(-1, riverType2, 3, 10, rivermin, rivermax);
  ...
  //  wet
    ...
    rmRiverConnectRiver(yellowRiver6, yellowRiver3, 0.5, 0.5, 0.5);
    rmRiverAddWaypoint(yellowRiver6, .5, .65);
    rmRiverAddWaypoint(yellowRiver6, .5, .55);
    rmRiverBuild(yellowRiver6);

    rmRiverConnectRiver(yellowRiver7, yellowRiver3, 0.5, 0.5, 0.5);
    rmRiverAddWaypoint(yellowRiver7, .5, .45);
    rmRiverAddWaypoint(yellowRiver7, .5, .35);
    rmRiverBuild(yellowRiver7);
  ...
  int StartAreaTreeID=rmCreateObjectDef("starting trees");
	...
	rmSetObjectDefMaxDistance(StartBerriesID, 18);
