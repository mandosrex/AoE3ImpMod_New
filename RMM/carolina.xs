...
void main(void)
{
   ...
   int playerConstraint=rmCreateClassDistanceConstraint("player vs. player", classPlayer, 20.0);
	...
	int TCvsTC=rmCreateTypeDistanceConstraint("TC avoid same", "TownCenter", 40.0);
   int CWvsCW=rmCreateTypeDistanceConstraint("CW avoid same", "CoveredWagon", 40.0);
...
//	rmSetAreaMix(invisContinentID, "carolina_grass");
  ...
  rmAddObjectDefConstraint(playerCrateID, shortAvoidImpassableLand);
   ...
   rmAddObjectDefItem(playerBerryID, "berryBush", rmRandInt(3,3), 2.0);
  ...
  rmAddObjectDefItem(farBerriesID, "berryBush", rmRandInt(6,8), 4.0);
  ...
  rmAddObjectDefItem(nearDeerID, "deer", rmRandInt(10,10), 10.0);
  rmSetObjectDefMinDistance(nearDeerID, 15);
  rmSetObjectDefMaxDistance(nearDeerID, 20);
  ...
  if(bonusChance<0.5)   
    rmAddObjectDefItem(farDeerID, "deer", rmRandInt(10,10), 10.0);
  else
    rmAddObjectDefItem(farDeerID, "deer", rmRandInt(13,13), 10.0);
  rmSetObjectDefMinDistance(farDeerID, 40);
  rmSetObjectDefMaxDistance(farDeerID, 50);
  ...
  for (i=0; <numTries) {   
   ...
   rmAddObjectDefItem(farHuntableID, "deer", rmRandInt(10,13), 6.0);
   rmSetObjectDefMinDistance(farHuntableID, 0.10);
   rmSetObjectDefMaxDistance(farHuntableID, 0.20);
   rmAddObjectDefConstraint(farHuntableID, avoidAll);
   rmAddObjectDefConstraint(farHuntableID, avoidDeer);
   rmAddObjectDefConstraint(farHuntableID, avoidAll);
   ...
   rmPlaceObjectDefAtLoc(farHuntableID, 0, 0.5, 0.5, 1);
