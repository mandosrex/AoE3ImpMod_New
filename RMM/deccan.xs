...
void main(void)
{
  ...
  if (rmAllocateSubCivs(3) == true) {
    ...
    subCiv2=rmGetCivID("Saltpeter");
		rmEchoInfo("subCiv1 is Saltpeter "+subCiv2);
		if (subCiv2 >= 0)
			rmSetSubCiv(2, "Saltpeter");
	}
  ...
  int avoidTC = rmCreateTypeDistanceConstraint("avoid TCs", "TownCenter", 30.0);
  ...
  int avoidFoodMid = rmCreateClassDistanceConstraint("avoid foods mid", foodClass, 30.0);
  ...
  int avoidHerdables=rmCreateTypeDistanceConstraint("avoids cattle", "ypWaterBuffalo", 60.0); 
  ...
  string nativeString3 = "saltpeter_0";
