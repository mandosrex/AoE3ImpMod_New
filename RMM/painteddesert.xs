...
// starting resources
	...
	rmSetObjectDefMaxDistance(playerSilverID, 10.0);
...
//   ----------------------------Bison Herd-----------------------------------
	...
	rmAddObjectDefItem(startBisonID, "bison", rmRandInt(9,9), 8.0);
	rmSetObjectDefCreateHerd(startBisonID, false);
	rmSetObjectDefMinDistance(startBisonID, 12);
	rmSetObjectDefMaxDistance(startBisonID, 16);
