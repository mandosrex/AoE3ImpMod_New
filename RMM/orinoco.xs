...
void main(void)
{
   ...
   // Nature avoidance
	...
	int avoidTapir=rmCreateTypeDistanceConstraint("Tapir avoids Tapir", "anteater", 45.0);
	int avoidTapirFar=rmCreateTypeDistanceConstraint("Tapir avoids Tapir Far", "anteater", 65.0);
   ...
   for(i=1; <cNumberPlayers)
   {
    ...
    rmAddObjectDefItem(playerCapybaraID, "capybara", rmRandInt(10,10), 10.0);
    rmSetObjectDefMinDistance(playerCapybaraID, 12);
    ...
    rmSetObjectDefCreateHerd(playerCapybaraID, false);
  ...
  if(rmGetIsKOTH()) {
	...
	rmAddObjectDefItem(tapirEastID, "anteater", rmRandInt(8,10), 13);
	...
	rmAddObjectDefItem(tapirWestID, "anteater", rmRandInt(8,10), 13);
	...
	tapirCount =4;
		for (i=0; <tapirCount)
		{
			...
			rmAddObjectDefItem(tapirRandomID, "anteater", rmRandInt(4,6), 11);
